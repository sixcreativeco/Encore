...
struct SignInDynamicContentView: View {
    ...
    var body: some View {
        GeometryReader { proxy in
            ZStack {
                backgroundGradient
                auroraView(proxy: proxy) // Added Aurora effect
    ...
    private func cardStack(proxy: GeometryProxy, elapsedTime: TimeInterval) -> some View {
        let laneData: [(yOffset: CGFloat, speed: Double, reversed: Bool, cards: [AnyView])] = [
            ...
            (yOffset: -70, speed: 80, reversed: false, cards: [ // Corrected direction
            ...
            (yOffset: 210, speed: 70, reversed: false, cards: [ // Corrected direction
...
fileprivate enum DummySignInData {
    ...
    static let nzFlight = FlightModel(airline: "Air New Zealand", flightNumber: "NZ102", departureAirport: "AKL", arrivalAirport: "SYD", departureTime: time(hour: 8, minute: 0))
    static let aaFlight = FlightModel(airline: "American Airlines", flightNumber: "AA118", departureAirport: "LAX", arrivalAirport: "JFK", departureTime: time(hour: 18, minute: 30))
    static let qfFlight = FlightModel(airline: "Qantas", flightNumber: "QF44", departureAirport: "SYD", arrivalAirport: "LAX", departureTime: time(hour: 10, minute: 0))
    static let sqFlight = FlightModel(airline: "Singapore Airlines", flightNumber: "SQ317", departureAirport: "SIN", arrivalAirport: "LHR", departureTime: time(hour: 23, minute: 0))
    static let ekFlight = FlightModel(airline: "Emirates", flightNumber: "EK413", departureAirport: "DXB", arrivalAirport: "AKL", departureTime: time(hour: 10, minute: 50))
    static let uaFlight = FlightModel(airline: "United Airlines", flightNumber: "UA90", departureAirport: "SFO", arrivalAirport: "SYD", departureTime: time(hour: 22, minute: 45))
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text("\(flight.departureAirport) → \(flight.arrivalAirport)").font(.system(size: 20, weight: .bold))
